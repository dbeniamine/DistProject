...
be sure that no process will be able to send a message \texit{older} than $m$ so
he can deliver $m$ and all the messages older than $m$ in his pending queue. As
soon as a node deliver one or many message, he will send an ack for the elder
