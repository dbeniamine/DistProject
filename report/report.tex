...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Protocol throughput with different number of nodes, all nodes broadcasting a message concurently.}
    \label{table:thr}
\end{table}
...
\infty}\frac{1}{2}$. Two important point appears int that formula, the first is
that we have an inferior limit for our throughput $\frac{1}{2}$. Secondly this limit 
...
the performances of the protocol are scalabel and become acceptable when
